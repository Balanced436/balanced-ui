...
const CardTitle = ({ children, ...rest}: CardSectionProps ) => {
  return <Typography variant={"title-medium"} className={`${styles.title}`} {...rest}>{children}</Typography>;
};
...
const CardBody = ({ children, ...rest}: CardSectionProps) => {
  return <Typography variant={"body-medium"} className={`${styles.body}`} {...rest}>{children}</Typography>;
};

const CardFooter = ({ children, ...rest }: CardSectionProps) => {
  return <Typography variant={"body-small"} className={`${styles.footer}`} {...rest}>{children}</Typography>;
};
